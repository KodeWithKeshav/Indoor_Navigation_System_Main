...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/admin',
        builder: (context, state) => const OrganizationListScreen(), // New Entry Point
        routes: [
           GoRoute(
                    ...
                    GoRoute(
                      ...
                      builder: (context, state) {
                         ...
                         if (state.extra is Map) {
                           floorName = (state.extra as Map)['floorName'] ?? 'Floor Details';
    ...
    redirect: (context, state) {
      ...
      final isGoingToAdmin = state.uri.toString().startsWith('/admin') && !isAdminLoggingIn;
      ...
      if (userProfileAsync.isLoading || (user == null && !userProfileAsync.hasError)) {
