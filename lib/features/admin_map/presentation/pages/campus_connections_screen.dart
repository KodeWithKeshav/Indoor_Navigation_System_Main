...
class CampusConnectionsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CampusConnectionsScreen> createState() =>
      _CampusConnectionsScreenState();
}

class _CampusConnectionsScreenState
    extends ConsumerState<CampusConnectionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final buildingsAsync = ref.watch(
      buildingsProvider(null),
    ); // null org for all/campus?
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              helperText: 'Approximate walking distance',
                            ),
                            ...
                            onPressed:
                                ...
                                : () async {
                                    ...
                                    final useCase = ref.read(
                                      addCampusConnectionUseCaseProvider,
                                    );
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: Text(
                                  '${getBldgName(conn.fromBuildingId)}  ⟷  ${getBldgName(conn.toBuildingId)}',
                                ),
                                subtitle: Text(
                                  '${conn.distance.toStringAsFixed(1)} meters',
                                ),
                                trailing: IconButton(
                                  icon: const Icon(
                                    Icons.delete,
                                  ...
                                  onPressed: () async {
                                    final useCase = ref.read(
                                      deleteCampusConnectionUseCaseProvider,
                                    );
