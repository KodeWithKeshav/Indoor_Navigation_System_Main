  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Help & Support', style: TextStyle(color: paperWhite, fontFamily: 'Courier', fontWeight: FontWeight.bold)),
        centerTitle: true,
        elevation: 0,
      ...
      body: ListView(
        ...
        children: [
           const Text(
             "HOW CAN WE HELP?",
             style: TextStyle(color: electricGrid, fontSize: 12, letterSpacing: 1.5, fontWeight: FontWeight.bold),
           ),
           ...
           Center(
             child: Text(
               ...
               style: TextStyle(color: Colors.redAccent.withOpacity(0.8), fontWeight: FontWeight.bold),
             ),
           )
        ],
      ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(title, style: const TextStyle(color: paperWhite, fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 4),
                  Text(subtitle, style: TextStyle(color: paperWhite.withOpacity(0.6), fontSize: 14)),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios, color: paperWhite.withOpacity(0.3), size: 16),
          ],
        ),
      ),
    );
